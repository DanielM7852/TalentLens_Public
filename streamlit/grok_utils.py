...
def get_explanation_with_grok(job_description: str, candidate_text: str, candidate_name: str, api_key: str | None = None) -> str:
    ...
    try:
        ...
        prompt = (
            ...
            "The second bullet MUST start with '- **Relevant Experience**:' and focus on how the candidate is relevant due to "
            "specific technical internships or projects that are similar to the job requirements. "
            "Mention the names of companies or projects and explicitly state how they align or are similar to the job description requirements. "
